...
def get_survey_responses(config, drop_uploads=True):
...
cleaned_fields = [
    ...
    "download-fail-expl",
    "download-fail-screen_Id",
    "download-fail-screen_Name",
    "download-fail-screen_Size",
    "download-fail-screen_Type",
